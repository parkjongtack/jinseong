	 ...
	 */
	 ...
	 function getPaging(fListScale,fPageScale,fTotal,fStart,fPagingUrl) {
	     ...
	     if(fTotal > fListScale) {
            ...
            fReturn = fReturn + "<table border='0' cellpadding='0' cellspacing='1' align='center'><tr><td class='paging'> ";

	         fPP=fStart-fListScale;
	         fNP=parseInt(fStart)+parseInt(fListScale);
	         // 처음으로 이동
	         if(fPP>=0) {
	        	 fReturn = fReturn + " <a href=\"javascript:normalSearch2('jibun',1);\">처음</a> ";
	         }
	         ...
	         if( fStart+1 >  fListScale*fPageScale ) {
	             ...
	             if(fPreStart<0)
	            	 fPreStart=-fPreStart;
	             fReturn  = fReturn + "<a href=\"javascript:normalSearch2('jibun'," +fPreStart+ ");\">이전</a> ";
	         ...
	         for(i=0; i < fPageScale ; i++) {
	             ...
	             if(fLn<fTotal) {
						...
						if(fLn!=fStart) {
							fReturn  = fReturn + " <a href=\"javascript:normalSearch2('jibun'," + fLn + ");\">" + fVk + "</a> "; }
						else {
	         ...
	         if(fTotal > ((fPage+1)*fListScale*fPageScale)) {
	             ...
	             fReturn  = fReturn + " <a href=\"javascript:normalSearch2('jibun'," + fNstart+ ");\">다음</a> ";
	         }
	         ...
	         if(fNP<fTotal) {
	             ...
	             fReturn  = fReturn + "<a href=\"javascript:normalSearch2('jibun'," + fLast+ ");\">마지막</a> ";
	         }
	...
	<div id="container">
		<div id="content">
			<ul class="tab">
				...
				<li><a href="#n" onclick="selectSearch('jibun');return false;"><img src="img/tab2.gif" alt="지번"/></a></li>
				...
				<form name="check" method="post">
					...
					<fieldset>
						...
						<tr>
							...
							<td class="SearchTd2"><select class="SearchSelectbox" title="시/군/구 선택"  name="county1" id="county1" onchange="javascript:changeAreaList(1, this);">
							<option value="">::선택::</option>
						...
						<tr>
							...
							<td class="SearchTd2"><select class="SearchSelectbox" id="town1_oldaddr" name="town1_oldaddr" title="지번주소" onchange="javascript:changeAreaList(1, this);">
							<option value="">::선택::</option>
						...
						<tr>
							<td class="SearchTd1"><label for="siCode4"><strong>리</strong></label></td>
							<td class="SearchTd2"><select id="ri1_oldaddr" name="ri1_oldaddr" title="지번주소"  class="small" style="width:153px">
								<option value="">::선택::</option>
							</select>
							<input type="checkbox" name="" value="" id="san" name="san"/>
							<label for="mut">산</label></td>
						</tr>
						<tr>
							<td class="SearchTd1"><label for="st_name"><strong>번&nbsp;&nbsp;지</strong></label></td>
							<td class="SearchTd2"><input type="text" name="bun1" value="" id="bun1" class="text" style="width:85px" onfocus= "javascript:focusItem(this);" onkeydown="checkKeyASearch();"/> - <input type="text" name="bun2" value="" id="bun2" class="text" style="width:85px" onfocus= "javascript:focusItem(this);" onkeydown="checkKeyASearch();"/></td>
						</tr>
						</table>
						 </div>
						<div class="btn">
							<a href="#"><img src="img/btn_search.gif" alt="검색" onclick="normalSearch('jibun','1');return false;" /></a>
						</div>
						<div >
