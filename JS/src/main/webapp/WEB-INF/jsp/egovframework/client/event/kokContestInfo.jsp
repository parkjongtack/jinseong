...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/event/kokContestInfo.do'/>";

});

function searchChk() {
	$("#frm").attr("action", "<c:url value='/event/kokContestInfo.do'/>");
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/event/kokContestInfoView.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
</script>
