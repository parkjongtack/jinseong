...
function goApp(){
	$("#frm").attr("action","/contest/contestAppWrite.do");
	$("#frm").submit();
}
...
function chkApp(){
	...
	*/
	...
	$.ajax({
		type : "POST",
		url : "/contest/appPermissionCheckJson.do",
		data : {			
					ct_seq : ct_seq
		},
		cache : false,
			            ...
			            <div class="bbs_view">
			                <div class="view_head">
			                    <dl class="subject">
			                        ...
			                        <dd class="info"><span><strong><c:out value='${contestView.reg_id }'/></strong></span><span><c:out value='${contestView.reg_dt }'/></span><span><c:out value='${contestView.hit }'/></span></dd>
			                    </dl>
			                    <dl class="file">
				                       	...
				                       	<table>
					                       	<tbody>
					                       		<tr>
						                            ...
						                            <td><span style="font-weight: bold; color: red;">3조</span> : <span style="color: blue; font-weight: bold;"><c:out value='${contestView.part3_app_cnt + contestView.part3_wait_cnt }'/>/<c:out value='${contestView.limit_part + contestView.limit_waiting  }'/></span></td>
						                            <td><span style="font-weight: bold; color: red;">4조</span> : <span style="color: blue; font-weight: bold;"><c:out value='${contestView.part4_app_cnt + contestView.part4_wait_cnt }'/>/<c:out value='${contestView.limit_part + contestView.limit_waiting  }'/></span></td>
					                       		</tr>
					                       	</tbody>
				                       	</table> 
				                    </dl>
