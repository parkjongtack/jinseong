...
<%
	...
	String sReturnUrl = "https://bowlingkorea.com/checkplus/pwFind_success.jsp"; // 성공시 이동될 URL
	String sErrorUrl = "https://bowlingkorea.com/checkplus/pwFind_fail.jsp"; // 실패시 이동될 URL
...
function goNext() {
	...
	checkClose();
	if ($("#auth").val() == "true") {
		f.action = "/membership/mpwFind.do";
		f.submit();
	} else {
...
function pwFind(){
	...
	$("#frm").attr("action", "/membership/pwFind2.do");
	$("#frm").submit(); 
	...
	<div id="contents">
		...
		<div class="sub_content">
			<div class="inner">
				...
				<div class="sub_head">
					<h3 class="c_tit">비밀번호 찾기</h3>
				</div>

				<div id="member">
					<div class="icoBx ic2">
						<p>비밀번호를 잊어버리셨나요?</p>
						<p>아이디, 이메일을 입력하신 후 [비밀번호 찾기]를 클릭하시면 회원님의 비밀번호를 찾아드립니다.</p>
						...
						<div class="findBx">
							<div class="fl f_phone">
								<p class="tit">휴대폰 인증으로 찾기</p>
									...
									<div class="find_txt">
										<div>
											<p>휴대폰 인증 후에 휴대폰 명의 정보로 비밀번호를 찾습니다.</p>
							...
							<form:form commandName="vo" id="frm" name="frm" member_id="frm" phone="frm" email="frm" method="post">
								...
								<div class="find_txt">
									<div>
										<dl>
											...
											<dd>
												<input id="id2" type="text" class="type-text required" name="mber_name" tabindex="1" maxlength="20">
											</dd>
										</dl>
										<dl>
											<dt>
											...
											<dd>
												<input id="id3" type="text" class="type-text required" name="mber_id" tabindex="2" maxlength="20">
										...
										<dl class="phone_input">
											...
											<dd>
												<input id="phone1" type="text" class="type-text required mr4" name="phoneNo1" tabindex="3" maxlength="3" pattern="\d*" placeholder=""> - 
												<input id="phone2" type="text" class="type-text required mr4" name="phoneNo2" tabindex="4" maxlength="4" pattern="\d*" placeholder=""> - 
												<input id="phone3" type="text" class="type-text required" name="phoneNo3" tabindex="5" maxlength="4" pattern="\d*" placeholder="">
										...
										<dl class="email_input">
											...
											<dd>
												<input type="text" id="email01" name="email01" class="type-text required" title="이메일1" tabindex="6" > @
												<input type="text" id="email02" name="email02" class="type-text required" title="이메일2" tabindex="7">
										...
										<div class="fd_btn">
											<a href="javascript:pwFind();" class="btn_or w200">확인</a>
										</div>
									</div>
								</div>
							</form:form>
