...
function goCancel() {
	...
	$.ajax({
		url		:	"<c:url value='/membership/myContestAppCancelCheckYn.do'/>",
		data	:	{
	...
	if(refundFlag){
		...
		$("#frmCancel").attr("action", "<c:url value='/membership/myContestAppCancel.do'/>");
		$("#frmCancel").submit();
	}
...
function goAppInfoUpdt(){
	...
	$("#frm").attr("action","<c:url value='/membership/myContestAppUpdate.do'/>");
	$("#frm").submit();
}
	        ...
	        <div class="sub_content">
	        	<div class="inner">
			        ...
			        <div class="board_view_area sub_fade">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td class="w_email">
                                            <input type="text" name="email1" id="email1" class="w100" maxlength="40" value="${email_arr0 }"/>@
                                            <input type="text" name="email2" id="email2" class="w100" value="${email_arr1 }"/>                                                                                       	
                                               	<select id="emailSelect" class="w100" onchange="chgDomain(this.value)">
			            ...
			            <!--TBL_VIEW //E -->
			            <div class="btn_r2">
				            <c:if test="${contestView.status ne '0003' && contestView.ct_seq ne '234'}">
