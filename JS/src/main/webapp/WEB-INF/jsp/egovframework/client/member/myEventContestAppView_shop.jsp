...
function goAppInfoUpdt(){
	...
	if(!$('input:radio[name=option1]').is(':checked')){
		alert("가장 선호하는 스톰의 프리미어라인볼 시리즈를 선택하세요.");
		$("#option1").focus();
		return;
	}
	
	if(!$('input:radio[name=option2]').is(':checked')){
		alert("가장 선호하는 스톰의 마스터라인볼 시리즈를 선택하세요.");
		$("#option2").focus();
		return;
	}
                                    ...
                                    <tbody>
                                    	<tr>
	                                        <th scope="col" colspan="4">
	                                        	<p style="font-weight: bold;">여러분의 의견을 듣고 싶습니다.&nbsp;<span class="ft_or">(*택1)</span></p>
	                                        </th>
	                                    </tr>
                                   	  	<tr>
	                                        <td colspan="4">
	                                        	<p class="opt_title">1. 가장 선호하는 스톰의 프리미어라인볼 시리즈는?</p>	
	                                        	<p class="opt_wrap">
	                                        		<label>
		                                        		<input type="radio" name="option1" value="1" <c:if test="${contestView.option1 eq '1' }">checked="checked"</c:if>>	
		                                        			DOMINATION
	                                        		</label>
	                                        		<label>
		                                        		<input type="radio" name="option1" value="2" <c:if test="${contestView.option1 eq '2' }">checked="checked"</c:if>>	
		                                        			LOCK
	                                        		</label>
	                                        		<label>
		                                        		<input type="radio" name="option1" value="3" <c:if test="${contestView.option1 eq '3' }">checked="checked"</c:if>>	
		                                        			CODE
	                                        		</label>
	                                        		<label>
		                                        		<input type="radio" name="option1" value="4" <c:if test="${contestView.option1 eq '4' }">checked="checked"</c:if>>	
		                                        			GATE
	                                        		</label>
	                                        		<label>
		                                        		<input type="radio" name="option1" value="5" <c:if test="${contestView.option1 eq '5' }">checked="checked"</c:if>>	
		                                        			PHYSIX
	                                        		</label>
	                                        	</p>
	                                        </td>
                                   	  	...
                                   	  	<tr>
	                                        <td colspan="4">
	                                        	<p class="opt_title">2. 가장 선호하는 스톰의 마스터라인볼 시리즈는?</p>	
	                                        	<p class="opt_wrap">
	                                        		<label>
		                                        		<input type="radio" name="option2" value="1" <c:if test="${contestView.option2 eq '1' }">checked="checked"</c:if>>	
		                                        			IQ
	                                        		</label>
	                                        		<label>
		                                        		<input type="radio" name="option2" value="2" <c:if test="${contestView.option2 eq '2' }">checked="checked"</c:if>>	
		                                        			MARVEL
	                                        		</label>
	                                        		<label>
		                                        		<input type="radio" name="option2" value="3" <c:if test="${contestView.option2 eq '3' }">checked="checked"</c:if>>	
		                                        			PHAZE
	                                        		</label>
	                                        		<label>
		                                        		<input type="radio" name="option2" value="4" <c:if test="${contestView.option2 eq '4' }">checked="checked"</c:if>>	
		                                        			AXIOM
	                                        		</label>
	                                        	</p>
	                                        </td>
