...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/board/eventList.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/board/eventDetail.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
                   ...
                   <div class="board_info">
                       ...
                       <div class="r_bx">
                           <div class="schBx">
                               ...
                               <label for="schKeword"><input type="text" name="srch_input"  value="${Srch_input }" class="w200"></label>
