...
function goBoardList(){
	$("#frm").attr("action", "<c:url value='/board/eventList.do'/>");
	$("#frm").submit();
}

function goPreBoardView(no){
	$("#frm").attr("action", "<c:url value='/board/eventDetail.do'/>");
	$("#ntt_id").val(no);
	$("#frm").submit();
}
			            ...
			            <div class="bbs_view">
			                <div class="view_head">
			                    <dl class="subject">
			                        ...
			                        <dd class="info"><span><strong><c:out value='${boardView.ntcr_nm }'/></strong></span><span><c:out value='${boardView.reg_dt }'/></span><span><c:out value='${boardView.rdcnt }'/></span></dd>
			                    </dl>
			                    <dl class="file">
