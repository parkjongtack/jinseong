...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/kegel/laneMachinesList.do'/>";

});

function searchChk() {
	$("#frm").attr("action", "<c:url value='/kegel/laneMachinesList.do'/>");
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/kegel/laneMachinesView.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
