...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/board/consultList.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/board/consultDetail.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
function chkApp(){
	...
	if(isLogin == false){
		...
		location.href = '/board/consultWrite.do';
	}
}	
