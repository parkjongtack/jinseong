		...
		$.ajax({
			...
			success	:	function(data){
				if(data.root.ResultCode == "Y"){
					...
					alert("이미 본 이벤트 또는 다른 이벤트에 접수하였습니다.");
                                        ...
                                        <tr <c:if test="${contestView.ct_type ne 'L' }"> style="display: none;"</c:if>>
                                            ...
                                            <td colspan="3">
                                            	<c:choose>
                                            		...
                                            		<c:when test="${contestView.ct_type eq 'A' || contestView.ct_type eq 'S'}">
		                                            	<select id="part" name="part" class="wd50p" >
                                    ...
                                    <!-- 
                                    	<tr>
	                                        ...
	                                        <td colspan="4">
	                                        	...
	                                        	<p class="opt_wrap">
	                                        		<label><input type="radio" name="option1" value="솔라 패럴랙스">솔라 패럴랙스</label>
	                                        		<label><input type="radio" name="option1" value="컴플리트 피직스">컴플리트 피직스</label>
	                                        		<label><input type="radio" name="option1" value="프로톤 피직스">프로톤 피직스</label>
	                                        	</p>
	                                        </td>
	                                    </tr>
                                   	  	<tr>
	                                        <td colspan="4">
	                                        	...
	                                        	<p class="opt_wrap">
	                                        		<input type="text" id="option2" name="option2" maxlength="10">
	                                        	</p>
	                                        </td>
	                                    </tr>
	                                  -->
