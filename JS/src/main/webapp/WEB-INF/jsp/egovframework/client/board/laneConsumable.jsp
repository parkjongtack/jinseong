...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/kegel/laneConsumableList.do'/>";

});

function searchChk() {
	$("#frm").attr("action", "<c:url value='/kegel/laneConsumableList.do'/>");
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/kegel/laneConsumableView.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
