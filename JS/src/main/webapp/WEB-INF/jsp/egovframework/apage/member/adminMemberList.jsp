...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/member/adminMemberList.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/member/adminMemberDetail.do'/>");
	$("#mber_id").val(val);
	$("#frmDetail").submit();
}
...
function goReg(){
	$("#frmDetail").attr("action","<c:url value='/apage/member/adminMemberWrite.do'/>");
	$("#frmDetail").submit();
}
...
<form:form commandName="vo" id="frmDetail" name="frmDetail">
	...
	<div id="container">
		...
		<div class="contents">
        	<ul class="ct-tab">
				<li class="tab1"><a href="<c:url value='/apage/member/adminMemberList.do'/>" class="on">회원정보관리</a></li>
