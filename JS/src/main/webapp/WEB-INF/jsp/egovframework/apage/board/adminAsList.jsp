...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/board/adminAsList.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/board/adminAsDetail.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
...
function goReg(){
	location.href = "<c:url value='/apage/board/adminAsWrite.do'/>";
}
	...
	<div id="container">
		...
		<div class="contents">
        	<ul class="ct-tab">
                ...
                <li class="tab1"><a href="<c:url value='/apage/board/adminAsList.do'/>" class="on">A/S게시판</a></li>
        	...
        	<div class="bbs-head">
            	...
            	<form:form commandName="vo" method="post" id="frm" name="frm">
	                <fieldset class="bbs-srch">
	                	...
	                	<form:select path="scType" class="w20p">
