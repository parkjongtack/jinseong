...
<head>
	...
	<body>
		<table border="1">
			<tr>
				<td colspan="15" style="text-align:center; font-weight:bold;font-size: 22px;">${contestView.ct_sbj }</td>				
			</tr>
			<tr>
				<td colspan="15" style="text-align:right;">출력일자 : <%=strDate %></td>				
			</tr>			
			<tr>
				...
				<c:choose>
            		<c:when test="${fn:length(contestAppList) > 0}">
		           	...
		           	<c:otherwise>
			           	<tr>
			           		<td style="text-align:center;" colspan="15">데이터가 없습니다.</td>
			           	</tr>
		           	</c:otherwise>
	           	</c:choose>		 
		</table>
