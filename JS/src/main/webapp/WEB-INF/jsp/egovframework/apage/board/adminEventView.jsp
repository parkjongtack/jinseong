...
function goModify(){
	$("#frm").attr("action", "<c:url value='/apage/board/adminEventModify.do'/>");
	$("#frm").submit();
}

function goDelete(){
	if(!confirm('삭제하시겠습니까?')) return;
	$("#frm").attr("action", "<c:url value='/apage/board/adminEventDelete.do'/>");
	$("#frm").submit();
}
		...
		<div class="bbs-view">
			<table>
				...
				<tbody>
					<tr>
						<th>제목</th>
						<td class="al_l" colspan="3"><c:out value='${boardView.ntt_sj }'/></td>
					</tr>
					<tr>
						<th>작성자</th>
