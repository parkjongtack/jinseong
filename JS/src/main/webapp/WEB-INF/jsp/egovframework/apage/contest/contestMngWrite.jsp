...
function goBoardList(){
	$("#frmGoList").attr("action", "<c:url value='/apage/contest/adminContestMngList.do'/>");
	$("#frmGoList").submit();
}
...
function goBoardWrite(){
	...
	$("#frm").attr("action", "<c:url value='/apage/contest/adminContestMngReg.do'/>");
	$("#frm").submit();
}
					...
					<tbody>
						...
						<tr>
							...
							<td class="al_l" colspan="3">
								...
								<span style="color: red; margin: 5px 0px; font-weight: bold; ">※대회 등록 후 반드시 수정페이지에서 최소한 자신의 대회는 추가하셔야 합니다.</span>
