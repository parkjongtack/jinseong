...
function goModify(){
	$("#frm").attr("action", "<c:url value='/apage/contest/adminContestModify.do'/>");
	$("#frm").submit();
}

function goDelete(){
	if(!confirm('삭제하시겠습니까?')) return;
	$("#frm").attr("action", "<c:url value='/apage/contest/adminContestDelete.do'/>");
	$("#frm").submit();
}
				...
				<tbody>
					...
					<tr>
						...
						<td class="al_l" colspan="3">
							<span>https://bowlingkorea.com/contest/contestInfoView.do?ntt_id=<c:out value='${contestView.ntt_id }'/>&currRow=1</span>
						</td>
					</tr>
					<tr>
