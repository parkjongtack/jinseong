...
<head>
	...
	<body>
		<table border="1">
			<tr>
				<td colspan="12" style="text-align:center; font-weight:bold;font-size: 22px;">${contestView.ct_sbj }</td>				
			</tr>
			<tr>
		...
		<table border="1">
			<tr>
				<td colspan="12" style="text-align:center; font-weight:bold;font-size: 18px;">3조</td>				
			</tr>			
			<tr>
				<td style="text-align:center; background-color:#c9c9c9">No</td>
				<td style="text-align:center; background-color:#c9c9c9">참가자명</td>
		...
		<table border="1">
			<tr>
				<td colspan="12" style="text-align:center; font-weight:bold;font-size: 18px;">4조</td>				
			</tr>			
			<tr>
				<td style="text-align:center; background-color:#c9c9c9">No</td>
				<td style="text-align:center; background-color:#c9c9c9">참가자명</td>
