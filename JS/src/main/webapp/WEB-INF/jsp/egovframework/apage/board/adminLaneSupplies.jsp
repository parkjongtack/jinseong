...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/board/adminLaneSupplies.do'/>";
...
function searchChk() {
	$("#frm").attr("action", "<c:url value='/apage/board/adminLaneSupplies.do'/>");
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/board/adminLaneSuppliesModify.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
...
function goReg(){
	location.href = "<c:url value='/apage/board/adminLaneSuppliesWrite.do'/>";
}
	...
	<div id="container">
		...
		<div class="contents">
        	<ul class="ct-tab">
                ...
                <li class="tab1"><a href="<c:url value='/apage/board/adminLaneSupplies.do'/>" class="on">레인정비소모품</a></li>
