...
function goBoardWrite(){
	...
	$("#frm").attr("action", "<c:url value='/apage/board/adminEventReg.do'/>");
	$("#frm").submit();
}
					...
					<tbody>
						<tr>
							...
							<td class="al_l" colspan="3">
								<input type="text" id="ntt_sj" name="ntt_sj" title="제목 입력" class="w40p" maxlength="150" >
							</td>
						</tr>
						<tr>
							<th>상단공지여부</th>
							<td class="al_l">
								<input type="radio" id="close" name="use_at" value="Y" /><label for="close">Y(사용)</label>
