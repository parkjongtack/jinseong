...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/board/adminTrainingList.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/board/adminTrainingModify.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
...
function goReg(){
	location.href = "<c:url value='/apage/board/adminTrainingWrite.do'/>";
}
	...
	<div id="container">
		...
		<div class="contents">
        	<ul class="ct-tab">
                ...
                <li class="tab1"><a href="<c:url value='/apage/board/adminTrainingList.do'/>" class="on">훈련 도구</a></li>         
