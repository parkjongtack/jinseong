...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/event/eventContestSelectResultList.do'/>";
...
function goBoardView(val){
	$("#frmDetail").attr("action", "<c:url value='/apage/event/eventContestSelectResultDetail.do'/>");
	$("#ct_seq").val(val);
	$("#frmDetail").submit();
}
	...
	<div id="container">
		...
		<div class="contents">
			...
			<ul class="ct-tab">
				...
				<li><a href="/apage/event/eventContestSelectResultList.do" class="on">선정결과관리</a></li>
				<li><a href="javascript:void(0);" class="">자리배치결과</a></li>
			</ul>
			<!-- //ct-tab -->
