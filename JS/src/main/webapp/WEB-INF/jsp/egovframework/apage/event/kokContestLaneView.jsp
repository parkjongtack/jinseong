...
function goDelete(){
	...
	$("#frm").attr("action", "<c:url value='/apage/event/kokContestLaneBoardDelete.do'/>");
	$("#frm").submit();
}
...
function sendMsg(){
	...
	$.ajax({
		//url		:	"<c:url value='/apage/event/kokContestLaneResultSendMsg.do'/>",
...
function getExcel(){
	$("#excelFrm").attr("action","/apage/event/kokContestSelectResulExcel.do");
	$("#excelFrm").submit();
}
