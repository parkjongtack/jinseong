...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/board/adminLaneMachines.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/board/adminLaneMachinesModify.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
...
function goReg(){
	location.href = "<c:url value='/apage/board/adminLaneMachinesWrite.do'/>";
}
	...
	<div id="container">
		...
		<div class="contents">
        	<ul class="ct-tab">
                ...
                <li class="tab1"><a href="<c:url value='/apage/board/adminLaneMachines.do'/>" class="on">레인정비기계</a></li>
