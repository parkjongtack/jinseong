...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/board/adminNoticeList.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/board/adminNoticeDetail.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
...
<form:form commandName="vo" id="frmDetail" name="frmDetail">
	...
	<div id="container">
		...
		<div class="contents">
        	<ul class="ct-tab">
				<li class="tab1"><a href="<c:url value='/apage/board/adminNoticeList.do'/>" class="on">공지사항</a></li>
