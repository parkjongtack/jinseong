...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/event/kokContestLaneList.do'/>";

});

function searchChk() {
	$("#frm").attr("action", "<c:url value='/apage/event/kokContestLaneList.do'/>");
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/event/kokContestLaneDetail.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
	...
	<div id="container">
		...
		<div class="contents">
			...
			<ul class="ct-tab">
				...
				<li><a href="/apage/event/kokContestMngList.do" class="">대회신청관리</a></li>
				<li><a href="/apage/event/kokContestLaneList.do" class="on">자리배치결과</a></li>
			</ul>
			<!-- //ct-tab -->
...
<c:if test="${!empty msg }" >
	...
	if(msg != ''){
		if(msg.indexOf('success') > 0){
			alert('삭제되었습니다.');	
			location.href = '/apage/event/kokContestLaneList.do';
		}
