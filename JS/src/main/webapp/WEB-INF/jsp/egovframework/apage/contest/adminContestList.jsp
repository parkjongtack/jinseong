...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/contest/adminContestList.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/contest/adminContestDetail.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
...
function goReg(){
	location.href = "<c:url value='/apage/contest/adminContestWrite.do'/>";
}
...
<form:form commandName="vo" id="frmDetail" name="frmDetail">
	...
	<div id="container">
		...
		<div class="contents">
        	<ul class="ct-tab">
				<li class="tab1"><a href="<c:url value='/apage/contest/adminContestList.do'/>" class="on">대회안내</a></li>
