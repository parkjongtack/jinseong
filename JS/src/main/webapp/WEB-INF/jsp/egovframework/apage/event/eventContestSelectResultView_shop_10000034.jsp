...
<tr>
	...
	<td>
		<select id="option1" name="option1">
			<option value="13"{{if option1 == '13'}}selected{{/if}}>13</option>
			<option value="14"{{if option1 == '14'}}selected{{/if}}>14</option>
			<option value="15"{{if option1 == '15'}}selected{{/if}}>15</option>
		</select>					
	</td>
	<td>\${waiting_num }</td>
	<td>
