...
$(document).ready(function () {
	...
	pagingUtil.__url			= "<c:url value='/apage/event/kokContestList.do'/>";
...
function goBoardView(val){
	...
	$("#frmDetail").attr("action", "<c:url value='/apage/event/kokContestDetail.do'/>");
	$("#ntt_id").val(val);
	$("#frmDetail").submit();
}
...
function goReg(){
	location.href = "<c:url value='/apage/event/kokContestWrite.do'/>";
}
...
<form:form commandName="vo" id="frmDetail" name="frmDetail">
	...
	<div id="container">
		...
		<div class="contents">
			...
			<!-- //ct-tab -->
			<ul class="ct-tab">
				<li><a href="/apage/event/kokContestList.do" class="on" id="part_firBtn">대회안내</a></li>
