...
function goBoardList(){
	$("#frmGoList").attr("action", "<c:url value='/apage/event/eventContestMngList.do'/>");
	$("#frmGoList").submit();
}
...
function goBoardWrite(){
	...
	$("#frm").attr("action", "<c:url value='/apage/event/eventContestMngReg.do'/>");
	$("#frm").submit();
}
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td class="al_l" colspan="3">
								<select title="접수타입 선택" name="ct_type" id="ct_type"  class="w20p" onchange="ctTypeChange(this.value)">
                                	...
                                	<option value="L">프리미엄 레슨 이벤트</option>
                                	<option value="A">프로암 이벤트</option>
                                	<option value="S">이벤트</option>
                                </select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<th>조별정원</th>
							<td class="al_l">
								<input type="number" id="limit_part" name="limit_part" title="정원 입력" class="w60p"> 명
							</td>
							<th>대기자정원</th>
							<td class="al_l">
								<input type="number" id="limit_waiting" name="limit_waiting" title="정원 입력" class="w60p"> 명
							</td>
						</tr>
						<tr>
							<th>노출여부</th>
						...
						<tr>
							...
							<!-- 
							 ...
							 -->	
								<span style="color: red; margin: 5px 0px; font-weight: bold; ">※접수 제한을 사용하실 경우 대회 등록 후 수정 페이지에서 접수 제한 대회를 선택해주세요.</span>
					...
					<tbody id="ctTypeWrap" style="display: none;">
						<tr>
							<th>프리미엄 레슨 이벤트</th>
							<td class="al_l" colspan="3" id="plConWrap">
							<!-- 
								<p id="plWrap1" class="plCl">
									<span>1조</span>
									<input type="text" class="w20p" name="list[0].part_name" value="">
									<a href="javascript:void(0);" class="btnAdd s-blue-btn">추가</a>
									<a href="javascript:void(0);" class="btnDel s-gry-btn" data-seq="1">삭제</a>
								</p>
							 -->
							</td>
						</tr>
